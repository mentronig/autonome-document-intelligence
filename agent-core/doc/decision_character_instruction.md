...
- _Neutral:_ "You are a helpful assistant."
- _Character:_ "You are 'Architect Prime', a strict, safety-obsessed engineer who hates sloppy code."

## Pros of a Character 🟢

1.  **Consistency:** The agent always answers in the same style (e.g., concise, professional).
2.  **Focus:** Assigning a role (e.g., "Senior QA Engineer") forces the LLM to adopt a specific _lens_. It will scrutinize code more than a generic "Assistant" would.
...
2.  **Bias:** A "Senior Architect" might refuse to write "quick and dirty" scripts because it thinks they are beneath it, even if you _need_ a quick script.
