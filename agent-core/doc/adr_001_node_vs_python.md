...
The client asked: _"Why not Pure Python?"_
...
- _State:_ "Did I succeed? What was the error? What is my history?"
...
By calling Python _only_ for what it does best (PDF parsing), we avoid Python's slower execution for general logic loops and gain Node.js's speed for the "glue code".
...
For a simple _script_, Pure Python is better.
For a robust _Agent_ that will evolve into a web platform, **Node.js (Logic) + Python (Tools)** is the superior architectural choice.
