...
**Description:** The user must maintain *two* distinct runtime environments (Node.js + Python) and keep them synchronized.
**Why it fails:** 
...
**Description:** The "Evolution" capability (Agent rewriting its own code) relies on the *intelligence* of the local LLM (`llama3:8b`).
**Why it fails:** 
