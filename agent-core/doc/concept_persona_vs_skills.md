...
*   **Beispiel (Lead Developer):**
    *   *Wert:* "Ich hasse unsauberen Code."
    *   *Verhalten:* "Ich warne den User, bevor ich etwas Lösche."
    *   *Tonfall:* "Direkt und technisch."
...
*   **Zweck:** Sie erweitern die *Fähigkeiten* des Agenten. Ohne Skill kann der Agent zwar denken (Persona), aber bestimmte Dinge (z.B. PDF lesen) vielleicht nicht tun.
...
**Zusammenspiel:**
Die **Persona** entscheidet *wann* und *wie* ein **Skill** eingesetzt wird.
*   *Szenario:* Ein User will Code pushen.
*   *Persona (Lead Dev):* "Halt! Das ist unsicher. Ich muss das erst prüfen."
*   *Skill (Code Review):* *Führt die Prüfung technisch durch.*
