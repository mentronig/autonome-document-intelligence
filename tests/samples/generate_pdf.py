...
pdf.multi_cell(
    ...
    10,
    txt=(
        "This document describes the changes for the T2 R2025.JUN release.\n\n"
        "2. PBI-123456: Fixed issue in RTGS GUI\n"
        "- Description: The RTGS GUI was not displaying the correct balance for "
        "specific liquidity transfers.\n"
        "- Impact: Low. Visual only.\n\n"
        "3. PBI-789012: Updated camt.053 schema validation\n"
        "- Description: The schema for camt.053 has been updated to include the "
        "new 'Clean Hydrogen' tax credit fields.\n"
