...
const skill_manager_1 = require("../../agent-core/src/skills/skill-manager");
...
describe('AgentCore Unit Tests', () => {
    ...
    const MockSkillManager = skill_manager_1.SkillManager;
    ...
    beforeEach(() => {
        ...
        MockOllama.prototype.generateCompletion.mockResolvedValue(JSON.stringify({
        ...
        MockSkillManager.prototype.getSkill.mockReturnValue(mockSkillInstance);
